...
export default function Home() {
  ...
  useEffect(() => {
    isOpen ? document.body.classList.add('menuOpen') : document.body.classList.remove('menuOpen')
  }, [isOpen])
  ...
  return (
    <main>
      <Head>
        ...
        <title>Shortly URL shortening API Challenge solution</title>
      </Head>

      <nav className={styles.navbar}>
        <div className={styles.navbar__left}>
          <div className={styles.navbar__logo}>
            <Image src="/assets/images/logo.svg" width={121} height={33} alt="adfasfsdafdsaf" />
          </div>

          <button onClick={handleClickMenu} className={styles.button__menu}>
        ...
        <div className={`${styles.navbar__right} ${isOpen ? styles.menu__open : ''}`}>
          <ul className={styles.navbar__menu}>
            <li className={styles.menu__item}><a href="">Feature</a></li>
            <li className={styles.menu__item}><a href="">Pricing</a></li>
            <li className={styles.menu__item}><a href="">Resources</a></li>
          </ul>
          <ul className={styles.navbar__login}>
            <li className={styles.button__navbar__login}><a href="">Login</a></li>
            <li className={styles.button__navbar}><a href="">Sign Up</a></li>
          </ul>
        </div>
      </nav>

    <section className={[styles.container, styles.section__home].join(' ')}>
      <div className={styles.col__left}>
        <h1 className={styles.left__title}>More than just Shorter links</h1>
        <p className={styles.left__content}>
          Build your brand’s recognition and get detailed insights on how your
          links are performing.
        </p>
        <button className={styles.button__cta}>Get Started</button>
      </div>
      <div className={styles.col__right}>
        <Image src="/assets/images/illustration-working.svg" width={733} height={482} alt="" />
      </div>
    </section>

    <section className={[styles.container, styles.container__search].join(' ')}>

      <ShortBox />

      <div className={[styles.section__name, styles.statistics].join(' ')}>
      ...
      <div className={styles.section__services}>
        <div className={[styles.cardgroup, styles.brand].join(' ')}>
          <div className={styles.cardgroup__image}>
            <Image src="/assets/images/icon-brand-recognition.svg" width={40} height={40} alt="" />
          </div>
          <h4 className={styles.cardgroup__title}>Brand Recognition</h4>
          <p className={styles.cardgroup__content}>
            Boost your brand recognition with each click. Generic links don’t
            mean a thing. Branded links help instil confidence in your content.
          </p>
        </div>
        <div className={[styles.cardgroup, styles.detailed].join(' ')}>
          <div className={styles.cardgroup__image}>
            <Image src="/assets/images/icon-detailed-records.svg" width={40} height={40} alt="" />
          </div>
          <h4 className={styles.cardgroup__title}>Detailed Records</h4>
          <p className={styles.cardgroup__content}>
            Gain insights into who is clicking your links. Knowing when and
            where people engage with your content helps inform better decisions.
          </p>
        </div>
        <div className={[styles.cardgroup, styles.fully].join(' ')}>
          <div className={styles.cardgroup__image}>
            <Image src="/assets/images/icon-fully-customizable.svg" width={40} height={40} alt="" />
          </div>
          <h4 className={styles.cardgroup__title}>Fully Customizable</h4>
          <p className={styles.cardgroup__content}>
      ...
      <footer className={styles.footer} >
        ...
        <div className={styles.footer__center}>
          <ul className={styles.footer__menu}>
            <li className={styles.menu__item}><a href="">Features</a></li>
            <li className={styles.menu__item}><a href="">Link Shortening</a></li>
            <li className={styles.menu__item}><a href="">Branded Links</a></li>
            <li className={styles.menu__item}><a href="">Analytics</a></li>
          </ul>
          <ul className={styles.footer__menu}>
            <li className={styles.menu__item}><a href="">Resources</a></li>
            <li className={styles.menu__item}><a href="">Blog</a></li>
            <li className={styles.menu__item}><a href="">Developers</a></li>
            <li className={styles.menu__item}><a href="">Support</a></li>
          </ul>
          <ul className={styles.footer__menu}>
            <li className={styles.menu__item}><a href="">Company</a></li>
            <li className={styles.menu__item}><a href="">About</a></li>
            <li className={styles.menu__item}><a href="">Our Team</a></li>
            <li className={styles.menu__item}><a href="">Carrers</a></li>
            <li className={styles.menu__item}><a href="">Contact</a></li>
          </ul>
        </div>
        <div className={styles.footer__right}>
          <ul className={styles.footer__social}>
            <li className={styles.social__item}><a href="">
